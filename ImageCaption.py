...
def process_batch_files(
    ...
    if g_model is None or g_processor is None:
        yield {batch_status_output: format_error("Model or processor not loaded. Please try again."), batch_zip_output: None}
        return
    ...
    try:
        ...
        dataloader = torch.utils.data.DataLoader(
            ...
            worker_init_fn=worker_init_fn  # Initialize processor in workers
        )
...
with gr.Blocks() as demo:
	...
	with gr.Tabs() as tabs:
		...
		with gr.TabItem("Batch Processing", id="batch_tab"):
			gr.HTML('Process Multiple ImagesUpload multiple images to generate captions in bulk. You\'ll receive a ZIP file with all the captions.')
